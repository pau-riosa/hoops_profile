defmodule HoopsProfileWeb.CoreComponents do
  @moduledoc """
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "phx-submit-loading:opacity-75 rounded-lg bg-brand hover:bg-blue-700/50 py-2 px-3",
  ...
  def header(assigns) do
    ~H"""
    <header class={[
      @actions != [] && "flex items-center justify-start gap-6 ",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HoopsProfileWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HoopsProfileWeb.Gettext, "errors", msg, opts)
    end
  end
